...
%		coorientador={Ciclano}, %% Para masculino
   ...
   implementados dentro da biblitoeca Pytorch\footnote{Biblioteca Python de aprendizado de máquina}.
    ...
    \begin{figure}\label{distarqui}
        \centering
        \includegraphics[width=0.6\textwidth]{./img/distarqui.png}
    ...
    \begin{figure}\label{fig:lossepochs}
        \centering
        \includegraphics[width=0.6\textwidth]{./img/lossepochs.png}
    ...
    \subsection{Validação Cruzada e \textit{Learning Rate Decay}}
