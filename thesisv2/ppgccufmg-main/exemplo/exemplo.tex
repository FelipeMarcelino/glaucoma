...
%		coorientador={Ciclano}, %% Para masculino
	...
	\chapter{Introdução}\label{intro}
        ...
        possível que com tratamente a evolução da doença seja mais lenta \citep{GARWAYHEATH201368}. O
        diagnóstico do glaucoma é feito através de imagens requer análise e interpretação de um especialista da
        ...
        (OD), copo óptico (OD-cup), mácula lútea, fóvea e os vasos sanguíneos \citep{SON202085jk,
        ...
        \begin{figure}\label{glaucomadiff}
            \centering
            \includegraphics[width=0.6\linewidth]{./img/glaucoma_diff.png}
        ...
        \begin{figure}\label{octdiff}
            \centering
            \includegraphics[width=0.6\linewidth]{./img/oct.jpg}
        ...
        (cluster\footnote{Adicionar significado de cluster!!!!}) ou até mesmo um smartphone com acesso a
        uma câmera.
    ...
    imagem/tabular para melhorar a desempenho do modelo.
    ...
    em relação ao cancer, presença de diabetes, é processado por uma outra rede neural multicamadas
    \ref{sec:model}. Ao final, os resultados é concatenados por uma outra rede neural multicamdas e
    ...
    a imagem com a presença de pneumonia (Ocasinada pelo vírus da COVID-10 ou outro vírus) ou não.
    ...
    teste\ref{trainval}, a divisão dos dados foram feita por paciente,
    ...
    Esta framework\footnote{ESCREVER AQUI!!!!} é acessível para o publico envias as fotos do fundo dos olhos e em seguida recebe o
    ...
    EfficientNet \citep{DBLP:journals/corr/abs-1905-11946} (Codificador) e UNet++
    ...
    \begin{figure}
        ...
        de blocos. Imagem retirada de \citep{designspace}}
        \label{fig:regnet}
    \end{figure}
    ...
    \begin{figure}
        ...
        \end{center}
        \caption{Exemplo de um bloco \textbf{X} baseado em uma rede residual. Imagem retirada de \citep{designspace}}
        \label{fig:regnet2}
    \end{figure}

    \begin{table}[!h]\label{tab:any}
    \begin{center}
    ...
    \end{tabular}
        \caption{Tabela de restrições dos modelos até chegar no modelo RegNet. O índice $i$ é o
        estágio, fixado em 4. O $b_{i}$ representa
        razão do gargalo, $g_{i}$ representa o total de canais da convolução , $d_{i}$ representa o
        total de blocos e o $w_{i}$ represnta o tamanho do bloco. Tabela retirada de
        \citep{designspace}}
    \end{center}
    \end{table}
    ...
    \begin{figure}
        ...
        espaços, sendo o C aquele que possui melhor desempenho entre eles. Imagem retirada de \citep{designspace}}
        \label{fig:space}
    \end{figure}
    ...
    !!! Apresentar detalhes sobre as versões utlizadas, total de parâmetros e desempenho de
    inferência.
    ...
    \citep{GoodBengCour16}, para transformar/limitar os valores. Todos os neurônios de uma camada
    possuí ligações com todos os neurônios da próxima camada.

    \begin{figure}\label{fig:redeneuralmlp}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/rede_neural_4.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/classic_overfitting.jpg}
        \caption{Uma imagem representando o problema de sobreajuste. Imagem retirada de: https://www.ibm.com/cloud/learn/overfitting}
    ...
    toda a imagem captando os traços mais marcantes. Explicando melhor, com uma imagem 32x32x3 e um
    filtro que cobre uma área de 5x5 da imagem com movimento de 2 saltos (chamado de stride), o
    filtro passará pela imagem inteira, por cada um dos canais, formando no final um \textit{feature
    map} ou \textit{activation map} de 28x28x1. A image a seguir mostra como uma convolução
    funciona:

    \begin{figure}\label{convexp}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/convoex.jpg}
        \caption{Exemplo de uma convolução.}
    \end{figure}
    ...
    dados disponíveis. Dado isso, iremos testar as seguintes arquiteturas mostradas na fígura
    \ref{fig:arqui}:
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/arqui1.png}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/arqui4.png}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/arqui2.png}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/arqui3.png}
    ...
    \begin{itemize}
        \item Acurácia: Quantos diagnósticos certos foram realizados pelo modelo.
        \item sensibilididade: É a capacidade do modelo de ser acertivo ao fazer diagnósticos positivo
            quanto a presença do glaucoma no paciente.
        \item Especificidade: É a capacidade do modelo em detectar todos os casos verdadeiros de
            glaucoma.
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/roc_curvas_threshold.png}
        \caption{Curva ROC}
        \label{fig:curvaroc}
    \end{subfigure}%%
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/auc_todas_curvas.png}
        \caption{Area sobre a curva (AUC)}
        \label{fig:auc}
    \end{subfigure}
    \caption{AUC e curva ROC. Imagens retirada de: https://cienciaenegocios.com/curva-roc-e-auc-em-machine-learning}
    \label{fig:rocauc}
    \end{figure}
    ...
    na imagem da direta \ref{auc}, mostra que se movimentarmos o threshold não perderíamos nada, e
    ...
    \begin{figure}
        \label{fig:cross}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/cross.png}
    ...
    geraram gráficos de dependência entre as váriaveis de entrada e a rótulo dos dados(Presen ou
    ...
    \begin{figure}
        \label{boston}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/shap_boston.png}
        \caption{Gráfico sumarizado para o dataset Boston Housing}
    \end{figure}

    Na figura \ref{boston} representa um gráfico SHAP para previsão dos preços de moradias em
    ...
    \begin{figure}
        \label{imgshap}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/gradient_imagenet_plot.png}
        \caption{Explicação de uma imagem utilizando SHAP.}
    \end{figure}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/foto1fundus.jpg}
        \caption{Imagem do fundo do olho distante do disco e copo}
        \label{fig:fundus2a}
    \end{subfigure}%%
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/foto2fundus.jpg}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/total_pacientes.png}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/total_olhos.png}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/total_glaucoma.png}
        \caption{Total de olhos com e sem glaucoma}
        \label{figexplorer:c}
    \end{subfigure}%%
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{./img/total_glaucoma_genero.png}
    ...
    Como podemos obervar nos histogramas da fígura \ref{figexplorer} é possível observar que temos mais
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1.0\linewidth]{./img/dist.png}
        \caption{Distribuição do Glaucoma por variável}
        \label{dist_glaucoma}
    \end{figure}

    Os gráficos da fígura \ref{dist_glaucoma} mostra a distriuição das variáveis do OCT quanto a
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1.0\linewidth]{./img/boxplot.png}
        \caption{Boxplot do Glaucoma por variável.}
        \label{boxplot}
    \end{figure}

    Existe uma presença de valores atípicos mostrados na fígura \ref{boxplot}. A idade, como
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{./img/correlacao.png}
        \caption{Correlação absoluta das variáveis}
        \label{corr}
    \end{figure}

    Existe uma forte correlação entre a variável TS e G. Sendo G uma média global, existe a
    possibilidade que a variável TS tenha uma influência forte na média. As variáveis que mais se correlacionam com a
    classe são: TS, TI e G.

    A seguir, uma sumarização dos dados após a limpeza:
    ...
    \begin{figure}\label{fig:engcorr}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/corr_eng_f.png}
    ...
    ou seja, 1.000.000.000 bytes, ou ainda 109 bytes.[1]} de
    ...
    \section{\textit{Learning Decay}}\label{sec:decay}

    \textit{Learning Decay} é uma tećnica de treinamento de rede neurais. O modelo começa com taxa
    de aprendizagem \textit{lr} e vai decaindo essa taxa múltiplas vezes durante o treinamento.
    ...
    Os seguinte trabalhos trazem um pouco do benefício do \textit{learning decay} \citep{lrpaper1,
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/learning_decay.png}
        \caption{\textit{Learning Rate Decay} aplicado a modelos visuais. Image retirada de \citep{lrpaper2}}
        \label{fig:lrdecay}
    \end{figure}
    ...
    \begin{itemize}
        \item Primeiro foram testados os seguintes modelos utilizando diferente configurações:
            ...
            etapa fornceu o melhor momento para aplicar o \textit{Learning Decay} e o \textit{Early
    ...
    geral dos modelos quanto a desempenho relação a nossa métrica principal, AUC
    \ref{sec:metrics}. Além disso, pela gráfico de perda (loss) teremos um ponto ideal para cada um
    dos modelos quanto a hora de aplicarmos a técnica de \textit{Learning Decay} \ref{sec:decay}
    para conseguirmos uma desempenho ainda melhor nas próximas etapas.

    \section{Desempenho Geral}

    \begin{figure}\label{fig:geralauc}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/melhor_auc_lr_learning.png}
    ...
    \begin{figure}\label{scatter}
        \begin{subfigure}[b]{0.5\linewidth}
            \centering
            \includegraphics[width=0.55\linewidth]{./img/scatter1.png}
            \caption{Comparação entre os modelos RegNet e todos os outros.}
            \label{fig:scatter1}
            \vspace{4ex}
        \end{subfigure}%%
        \begin{subfigure}[b]{0.5\linewidth}
            \centering
            \includegraphics[width=0.55\linewidth]{./img/scatter2.png}
            \caption{Comparação entre os modelos j}
            \label{fig:scatter2}
            \vspace{4ex}
        \end{subfigure}%%
        \captio{Comparação das estatisticas da métrica AUC. O eixo y é o melhor resultado do modelo
        durante todas as épocas, enquanto o eixo x é a média do modelo durante o treinamento.}
    \end{figure}

    O gráfico \ref{scatter} usa a média da AUC no treinamento e o valor máximo atingido para
    ...
    \begin{center}
        \input{./tables/mean_std_min_max_backbone_auc.tex}\label{tab:aucbackbone}
        \input{./tables/mean_std_min_max_double_oct_auc.tex}\label{tab:aucdboct}
    \end{center}

    As tabelas \ref{tab:aucbackbone} e \ref{tab:aucdboct} sumarizam todas as execuções dos
    ...
    \begin{figure}\label{distarqui}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/distarqui.png}
        \caption{Distribuição dos desempenhos separado por arquiteturas de modelos}
    \end{figure}

    A distruição dos desempenhos apresentados na fígura \ref{distarqui} mostra uma seperação clara
    ...
    100 partes, cada uma com uma percentagem de dados aproximadamente igual. O k-ésimo percentil Pk
    é o valor x (xk) que corresponde à frequência cumulativa de N .k/100, onde N é o tamanho
    ...
    momento que aplicamos o \textit{Early Stopping} e o \textit{Learning Decay} para próxima fase de
    experimentos utilizando validação cruzada.


    \begin{figure}\label{fig:lossepochs}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/lossepochs.png}
    ...
    \subsection{Validação Cruzada e \textit{Learning Decay}}
    ...
    comparação entre a utilização do \textit{Learning Decay} utilizando validação cruzada.
    ...
    \input{./tables/results_ld.tex}

    A fígura \ref{fig:crosscompare} mostra a distribuição do desempenho dos modelos testados. O
    \textit{Learning Decay} trouxe uma melhora significativa para as duas arquiteturas. Apesar de
    ...
    \begin{figure}\label{fig:crosscompare}
        \centering
        \includegraphics[width=0.6\linewidth]{./img/cross_compare.png}
        \caption{Comparação do uso do \textit{Learning Decay} nos melhores modelos. Os melhores
    ...
    \section{Explicabilidade}\ref{sec:resultexp}
    ...
    técnica de \textit{Learning Decay} apresentou benefícios para os modelos, aumentando seu
