...
%		coorientador={Ciclano}, %% Para masculino
   ...
   implementados dentro da biblitoeca Pytorch\footnote{Biblioteca Python de aprendizado de máquina}.
    ...
    A tabela~\ref{tab:randaug} a seguir mostra os resultados dos experimentos. Apesar de não ter
    trago benefícios significantes nas métricas, principalmente na AUC, o algoritmo diminuíu a
    variação do desempenho da métrica AUC. Desta forma, é possível verificar que o \textit{Data
    Augmentation} é uma ferramenta para lidar com o problema de sobreajsute\ref{sec:overfitting} dos modelos.
